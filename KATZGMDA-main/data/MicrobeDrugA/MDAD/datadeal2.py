...
drug_sim = np.loadtxt('C:\新建文件夹\MKGCN-main\data\MicrobeDrugA\MDAD\drugsimilarity.txt')
mic_sim = np.loadtxt('C:\新建文件夹\MKGCN-main\data\MicrobeDrugA\MDAD\microbesimilarity.txt')
